/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareBindings` (hash: d90e510ffc18da957029982360811d52)
...
declare namespace Cloudflare {
	...
	interface DevEnv {
		...
		DATABASE_URL: "postgresql://joy-karmakar:admin123@localhost/hono_server";
		ALLOWED_ORIGINS: "http://localhost:5173,http://localhost:5000,http://localhost:8081,http://127.0.0.1:8081";
		AUTH_SERVER: "http://localhost:5000";
	}
	interface Env {
		NODE_ENV: "development" | "prod";
		DATABASE_URL: "postgresql://joy-karmakar:admin123@localhost/hono_server" | "postgresql://postgres.wnxozxmunrooatccrjbv:cvuR7BF0IntBa5kh@aws-1-ap-south-1.pooler.supabase.com:6543/postgres";
		ALLOWED_ORIGINS: "http://localhost:5173,http://localhost:5000,http://localhost:8081,http://127.0.0.1:8081";
		AUTH_SERVER: "http://localhost:5000" | "https://auth-server-sage.vercel.app";
		R2_BUCKET?: R2Bucket;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "NODE_ENV" | "DATABASE_URL" | "ALLOWED_ORIGINS" | "AUTH_SERVER">> {}
}
